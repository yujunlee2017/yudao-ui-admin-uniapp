...
| 月份 | 文档 | 结论 |
| --- | --- | --- |
| 2025-12 | [2025-12.md](./2025-12.md) | 只适合抽依赖、tabbar 和初始化脚本相关修复；不要整月合并。 |
| 2026-01 | [2026-01.md](./2026-01.md) | 主要关注 dev-tools 输出目录小修和 router 修复。 |
| 2026-02 | [2026-02.md](./2026-02.md) | 噪音最多；`b9ef57a5` 统一提取 token 响应式和 dev-tools，不引入 monorepo CLI。 |
