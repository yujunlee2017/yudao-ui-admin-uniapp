<template>
  <view class="yd-page-container">
    ...
    <wd-cell-group border>
      ...
      <wd-cell title="浏览时间" :value="formatDateTime(createTime) || '-'" />
    </wd-cell-group>
  </view>
</template>
...
// 详情字段经列表页路由参数透传，避免浏览记录接口无 get 时“取前 100 条再 find”
...
const createTime = computed(() => props.createTime ? decodeURIComponent(props.createTime) : '') // 浏览时间

/** 返回上一页 */
function handleBack() {
  navigateBackPlus('/pages-mall/product/browse-history/index')
}
</script>
