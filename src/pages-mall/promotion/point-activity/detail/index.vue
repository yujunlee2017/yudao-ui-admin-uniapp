...
const canUpdate = computed(() => hasAccessByCodes(['promotion:point-activity:update']))
const canDelete = computed(() => hasAccessByCodes(['promotion:point-activity:delete']))
const canClose = computed(() => hasAccessByCodes(['promotion:point-activity:close']))
