...
const canUpdate = computed(() => hasAccessByCodes(['promotion:bargain-activity:update']))
const canDelete = computed(() => hasAccessByCodes(['promotion:bargain-activity:delete']))
const canClose = computed(() => hasAccessByCodes(['promotion:bargain-activity:close']))
