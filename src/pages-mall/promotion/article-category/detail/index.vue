...
const canUpdate = computed(() => hasAccessByCodes(['promotion:article-category:update']))
const canDelete = computed(() => hasAccessByCodes(['promotion:article-category:delete']))
