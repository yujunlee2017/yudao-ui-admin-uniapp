...
const canUpdate = computed(() => hasAccessByCodes(['promotion:seckill-activity:update']))
const canDelete = computed(() => hasAccessByCodes(['promotion:seckill-activity:delete']))
const canClose = computed(() => hasAccessByCodes(['promotion:seckill-activity:close']))
