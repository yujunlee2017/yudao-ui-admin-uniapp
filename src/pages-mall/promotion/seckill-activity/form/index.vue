      ...
      <wd-form ref="formRef" :model="formData" :schema="formSchema">
        <view class="p-24rpx">
          ...
          <view class="mb-24rpx overflow-hidden rounded-12rpx bg-white shadow-sm">
            ...
            <view class="p-24rpx">
              <wd-checkbox-group v-model="configIds" shape="button">
                <wd-checkbox v-for="config in configList" :key="config.id" :model-value="config.id">
                  {{ config.name }}
                </wd-checkbox>
              </wd-checkbox-group>
            </view>
              ...
              >
                <template #sku="{ row }">
                  <view class="flex items-center gap-12rpx py-8rpx">
                    ...
                    <wd-input-number v-model="row.seckillPrice" :min="0" :step="0.01" />
                  </view>
                  <view class="flex items-center gap-12rpx py-8rpx">
