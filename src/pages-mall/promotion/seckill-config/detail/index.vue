  ...
  <view class="yd-page-container">
    ...
    <view v-if="canUpdate || canDelete" class="yd-detail-footer">
      <view class="yd-detail-footer-actions">
        ...
        <wd-button v-if="canUpdate" class="flex-1" type="info" :loading="submitting" @click="handleToggle">
...
const canUpdate = computed(() => hasAccessByCodes(['promotion:seckill-config:update']))
const canDelete = computed(() => hasAccessByCodes(['promotion:seckill-config:delete']))
