...
const canUpdate = computed(() => hasAccessByCodes(['promotion:combination-activity:update']))
const canDelete = computed(() => hasAccessByCodes(['promotion:combination-activity:delete']))
const canClose = computed(() => hasAccessByCodes(['promotion:combination-activity:close']))
