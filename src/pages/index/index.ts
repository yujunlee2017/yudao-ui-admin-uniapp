  ...
  },
  {
    ...
    menus: [
      ...
      },
      {
        ...
        name: '客户统计',
        icon: 'dashboard',
        url: '/pages-crm/statistics/customer/index',
        iconColor: '#1677ff',
      ...
      },
      {
        ...
        name: '销售漏斗',
        icon: 'dashboard',
        url: '/pages-crm/statistics/funnel/index',
        iconColor: '#722ed1',
      ...
      },
      {
        ...
        name: '员工业绩',
        icon: 'dashboard',
        url: '/pages-crm/statistics/performance/index',
        iconColor: '#52c41a',
      ...
      },
      {
        ...
        name: '客户画像',
        icon: 'dashboard',
        url: '/pages-crm/statistics/portrait/index',
        iconColor: '#eb2f96',
      ...
      },
      {
        ...
        name: '排行榜',
        icon: 'dashboard',
        url: '/pages-crm/statistics/rank/index',
        iconColor: '#faad14',
