  ...
  <view class="yd-page-container">
    ...
    <view v-if="formData && isDraft" class="yd-detail-footer">
      <view class="yd-detail-footer-actions">
        ...
        <wd-button v-if="hasAccessByCodes(['mes:qc-iqc:update'])" class="flex-1" type="success" :loading="finishing" @click="handleFinish">
          完成
        </wd-button>
...
async function getDetail() {
  ...
  try {
    toast.loading('加载中...')
    formData.value = await getIqc(currentId.value)
  } finally {
    toast.close()
  }
}
