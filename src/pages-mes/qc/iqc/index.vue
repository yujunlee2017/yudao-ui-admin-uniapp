<template>
  <view class="yd-page-container yd-page-container-paging">
    ...
    <view v-if="hasAccessByCodes(['mes:qc-iqc:export'])" class="bg-white px-24rpx pb-16rpx">
    ...
    >
      <view class="p-24rpx">
        ...
        >
          ...
          <view v-if="isDraft(item) && (hasAccessByCodes(['mes:qc-iqc:update']) || hasAccessByCodes(['mes:qc-iqc:delete']))" class="flex justify-end gap-16rpx border-t border-t-[#f0f0f0] pt-20rpx" @click.stop>
            <wd-button v-if="hasAccessByCodes(['mes:qc-iqc:update'])" size="small" type="warning" @click="handleEdit(item)">
              编辑
            </wd-button>
            <wd-button v-if="hasAccessByCodes(['mes:qc-iqc:delete'])" size="small" type="danger" @click="handleDelete(item)">
              删除
            </wd-button>
          </view>
        </view>
