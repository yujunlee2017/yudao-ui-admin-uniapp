<template>
  ...
  >
    <view class="yd-search-form-container">
      ...
      <yd-search-picker v-model="formData.status" label="状态" :dict-type="DICT_TYPE.MES_DV_CHECK_RECORD_STATUS" all-option :all-value="undefined" />
...
const checkTimeRange = ref<[number | undefined, number | undefined]>() // 点检时间范围
