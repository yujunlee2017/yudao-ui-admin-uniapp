<template>
  <view class="yd-page-container yd-page-container-paging">
    ...
    <!-- 导出入口 -->
    <view v-if="hasAccessByCodes(['mes:wm-return-issue:export'])" class="bg-white px-24rpx py-16rpx">
      <view
...
async function handleExport() {
  ...
  try {
    await downloadApiFile('/mes/wm/return-issue/export-excel', queryParams.value, '生产退料单.xls')
  } finally {
