<template>
  <view class="yd-page-container yd-page-container-paging">
    ...
    <!-- 导出入口 -->
    <view v-if="hasAccessByCodes(['mes:wm-sales-notice:export'])" class="bg-white px-24rpx py-16rpx">
      <view
...
async function handleExport() {
  ...
  try {
    await downloadApiFile('/mes/wm/sales-notice/export-excel', queryParams.value, '发货通知单.xls')
  } finally {
