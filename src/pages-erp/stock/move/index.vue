...
const canDelete = computed(() => hasAccessByCodes(['erp:stock-move:delete'])) // 是否可删除
...
/** 点击卡片 */
function handleCardClick(item: StockMove) {
  if (selecting.value) {
...
/** 左滑删除 */
async function handleSwipeDelete(item: StockMove) {
