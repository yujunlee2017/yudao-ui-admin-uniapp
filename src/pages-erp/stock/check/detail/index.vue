  ...
  <view class="yd-page-container">
    ...
    <view v-if="hasFooter" class="yd-detail-footer">
      <view class="yd-detail-footer-actions">
        ...
        <wd-button v-if="hasAccessByCodes(['erp:stock-check:delete'])" class="flex-1" type="danger" :loading="deleting" @click="handleDelete">
          删除
        </wd-button>
      </view>
    </view>
...
const hasFooter = computed(() => canUpdate.value || hasAccessByCodes(['erp:stock-check:delete']) || canUpdateStatus.value)
