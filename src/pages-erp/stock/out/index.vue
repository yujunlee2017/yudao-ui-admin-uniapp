...
import { deleteStockOut, getStockOutPage } from '@/api/erp/stock/out'
...
const canDelete = computed(() => hasAccessByCodes(['erp:stock-out:delete'])) // 是否可删除
...
/** 点击卡片 */
function handleCardClick(item: StockOut) {
  if (selecting.value) {
...
/** 左滑删除 */
async function handleSwipeDelete(item: StockOut) {
