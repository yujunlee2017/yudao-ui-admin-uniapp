...
const canDelete = computed(() => hasAccessByCodes(['erp:finance-receipt:delete'])) // 是否可删除
...
/** 点击卡片 */
function handleCardClick(item: FinanceReceipt) {
  if (selecting.value) {
...
/** 左滑删除 */
async function handleSwipeDelete(item: FinanceReceipt) {
