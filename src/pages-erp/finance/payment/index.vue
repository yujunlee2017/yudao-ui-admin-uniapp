...
const canDelete = computed(() => hasAccessByCodes(['erp:finance-payment:delete'])) // 是否可删除
...
/** 点击卡片 */
function handleCardClick(item: FinancePayment) {
  if (selecting.value) {
...
/** 左滑删除 */
async function handleSwipeDelete(item: FinancePayment) {
