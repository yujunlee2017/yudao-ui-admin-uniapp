            ...
            <view :class="selecting ? 'pl-80rpx' : ''">
              <view class="p-24rpx">
                ...
                <view class="mb-12rpx flex text-28rpx text-[#666]">
                  ...
                  <view class="flex-1">
                    <text class="mr-8rpx text-[#999]">已付：</text>{{ formatMoney(item.paymentPrice) }}
                  </view>
                </view>
                <view class="flex text-28rpx text-[#666]">
                  <view class="flex-1">
                    <text class="mr-8rpx text-[#999]">应付：</text>{{ formatMoney(item.totalPrice) }}
                  </view>
                  <view class="flex-1">
                    <text class="mr-8rpx text-[#999]">未付：</text>{{ formatMoney(getUnpaidPrice(item)) }}
                  </view>
                </view>
              </view>
            </view>
...
import { deletePurchaseIn, getPurchaseInPage } from '@/api/erp/purchase/in'
...
const canDelete = computed(() => hasAccessByCodes(['erp:purchase-in:delete'])) // 是否可删除
...
/** 左滑删除 */
async function handleSwipeDelete(item: PurchaseIn) {
