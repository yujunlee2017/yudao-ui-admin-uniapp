      ...
      <view v-if="items.length > 0" class="mt-24rpx">
        ...
        <view class="px-24rpx">
          ...
          >
            ...
            <view v-if="item.totalCount != null && item.totalCount !== ''" class="mb-10rpx flex text-26rpx text-[#666]">
...
async function getDetail() {
  ...
  try {
    toast.loading('加载中...')
    formData.value = await enrichErpDocumentDetail(await getPurchaseIn(props.id), 'purchase-in')
  } finally {
    toast.close()
  }
}
