...
const canDelete = computed(() => hasAccessByCodes(['erp:supplier:delete'])) // 是否可删除
...
/** 点击卡片 */
function handleCardClick(item: Supplier) {
  if (selecting.value) {
...
/** 左滑删除 */
async function handleSwipeDelete(item: Supplier) {
