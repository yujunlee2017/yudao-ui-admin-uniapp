    ...
    <view class="h-full flex flex-col bg-[#f5f5f5]">
      ...
      <view class="bg-white px-24rpx pb-20rpx">
        ...
        <wd-picker
          ...
          :model-value="queryParams.productId"
          :columns="productOptions"
          label-key="name"
          value-key="id"
          @confirm="({ value }) => queryParams.productId = value[0]"
        />
      ...
      <scroll-view class="min-h-0 flex-1" scroll-y scroll-with-animation @scrolltolower="handleLoadMore">
        <view class="p-24rpx">
          ...
          <view v-if="!loading && list.length === 0" class="py-80rpx text-center">
            <wd-empty icon="content" tip="暂无可出库订单" />
          </view>
...
const productPickerVisible = ref(false) // 产品选择器状态
