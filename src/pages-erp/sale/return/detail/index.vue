      ...
      <view v-if="items.length > 0" class="mt-24rpx">
        ...
        <view class="px-24rpx">
          ...
          >
            ...
            <view v-if="item.outCount != null && item.outCount !== ''" class="mb-10rpx flex text-26rpx text-[#666]">
...
async function getDetail() {
  ...
  try {
    toast.loading('加载中...')
    formData.value = await enrichErpDocumentDetail(await getSaleReturn(props.id), 'sale-return') as SaleReturn
  } finally {
    toast.close()
  }
}
