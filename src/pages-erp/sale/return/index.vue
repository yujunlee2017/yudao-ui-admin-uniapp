<template>
  <view class="yd-page-container yd-page-container-paging">
    ...
    <ExportAction module-key="sale-return" :params="queryParams" />
...
import { deleteSaleReturn, getSaleReturnPage } from '@/api/erp/sale/return'
...
const {
  ...
  deleteApi: (ids: number[]) => deleteSaleReturn(ids),
  reloadEvent: 'erp:sale-return:reload',
})
