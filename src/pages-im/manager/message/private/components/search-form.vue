<template>
  ...
  >
    <view class="yd-search-form-container">
      <!-- TODO @AI：userselect 组件；看看有没别的，也有类似的问题 -->
      ...
      <view class="yd-search-form-item">
        ...
        <wd-input v-model="formData.receiverId" type="number" placeholder="请输入接收人编号" clearable />
      </view>
      <!-- TODO @AI：内容类型 -->
      <view class="yd-search-form-item">
        <view class="yd-search-form-label">
...
const placeholder = computed(() => {
  ...
  if (formData.receiverId) {
    conditions.push(`接收人:${formData.receiverId}`)
  }
  if (formData.content) {
