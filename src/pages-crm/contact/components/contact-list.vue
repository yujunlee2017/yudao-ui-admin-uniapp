...
async function getList() {
  ...
  try {
    ...
    const data = props.businessId
      ? await getContactPageByBusiness({ pageNo: 1, pageSize: 20, businessId: props.businessId, customerId: props.customerId })
      : await getContactPageByCustomer({ pageNo: 1, pageSize: 20, customerId: props.customerId! })
